...
similarity are useful extensions to Schelling's model as they can aid in describing complex and apparently contradicting segregation scenarios.  In modern, multi-ethnic societies, this complexity emerges for the cohexistence of n the boundaries of segregation can comprise not only ethnic boundaries, but numerous other dimensions such as socio-economic status or ideologies that are crossed by migrants
