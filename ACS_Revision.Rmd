...
similarity are useful extensions to Schelling's model as they can aid in describing complex and apparently contradicting segregation scenarios. In modern, multi-ethnic societies people segregate not only along ethnic boundaries, but many dimensions from social class to cultural norms, which can increase or decrease the distance between ethnic groups. From an intergenerational perspective, the degree of adaptation of previous generations from minority groups along such boundaries constitutes the antecedent for the successful investment of new generations in the receiving society [@Esser2010]. This has clearly implications for the cohesion of societies itself. We believe that the complex system perspective and agent-based modeling can support empirical research in this field and, in particular, that the extension of value-oriented tolerant agents in Schelling's model will find future applications in this direction.
